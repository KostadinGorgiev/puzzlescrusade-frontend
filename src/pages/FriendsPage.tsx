        ...
        <div className="fixed left-0 bottom-[25.33vw] px-[5.86vw] w-screen">
          ...
          <div className="flex gap-[5.6vw]">
            <div
              ...
              onClick={() => utils.shareURL(`${process.env.REACT_APP_BOT_URL}?startapp=ref${user.t_user_id}`, `👋 I've got something really cool - the first Build-to-Earn game on Telegram!🚀 Join PuzzlesCrusade using my link, and you'll get a powerful starting bonus💸`)}
            >
